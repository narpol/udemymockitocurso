...
class ExamenServiceImplTest {
    ...
    void testManejoException() {
        ...
        verify(repository).findAll();
        verify(preguntaRepository).findPreguntaPorExamenId(null);
    }
    ...
    void testArgumentMatchers() {
        ...
        verify(preguntaRepository).findPreguntaPorExamenId(argThat(arg -> arg != null && arg >= 5L));
...
//        when(preguntaRepository.findPreguntaPorExamenId(anyLong())).thenReturn(preguntas);
        ...
        Examen examen = examenService.findExamenPorNombreConPregunta("Matemáticas");
